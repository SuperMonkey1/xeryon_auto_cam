...
### PARAMETERS
parameters_excel_file = 'parameters_xls_3_top_plate_onder.xlsx'     # Replace with your Excel file path
template_file = 'template_xls_3_top_plate_onder.H'  # Replace with your template file path
